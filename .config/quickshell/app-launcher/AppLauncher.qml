...
Scope {
  ...
  Loader {
    id: themeLoader
    source: "file://" + Quickshell.env("HOME") + "/.config/quickshell/wallpaper/DefaultTheme.qml"
  }
  ...
  Connections {
    ...
    function onThemeUpdated() {
      themeLoader.source = ""
      themeLoader.source = "file://" + Quickshell.env("HOME") + "/.config/quickshell/wallpaper/DefaultTheme.qml"
    }
  }
